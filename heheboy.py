...
text_id.pack()
button_1 = Button(root, text='nao', bg='#ffb3c1', command=denied, relief=RIDGE, font=('Montserrat', 8, 'bold'))
button_1.pack()
root.bind('<Motion>', move_button_1)
button_2 = tk.Button(root, text='sim', bg='#ffb3c1', relief=RIDGE, command=accepted, font=('Montserrat', 14, 'bold'))
button_2.pack()
root.mainloop()
